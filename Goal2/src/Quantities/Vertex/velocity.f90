...
contains
    ...
    subroutine Calculate_derivatives(this, coordinates, total_vof, total_volume, nx, ny, nz, emf)
        ...
        !$omp target update to(dvel_x_dx, dvel_x_dy, dvel_x_dz, dvel_y_dx, dvel_y_dy, dvel_y_dz, dvel_z_dx, dvel_z_dy, dvel_z_dz, velocity_x, velocity_y, velocity_z)
        !$omp target teams distribute parallel do simd collapse(3) num_threads(this%parallel_params%nthreads) &
        ...
        !$omp& u5u8u1, u6u5u7, u6u7u2, u6u5u2, u7u6u8, u7u8u3, u7u6u3, u8u7u5, u8u5u4, u8u7u4, &
